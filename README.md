...
Segment A includes: a 3.3v 500Mah battery, a charging module (TP4056), STM32F411CEU6 essentially the brain; essentially where the CNN lives and all the logic. OV5460-A71A, the 5mp camera which takes the photos of the Microfluidic chamber. TP4056, the charging module which charges the battery. The HM-10 the bluetooth chip which sends information to the phone of the user. The wiring still needs to be down between the HM-10 and the STM32F411CEU6 (brain and bluetooth) and the HM-10 with the battery. 
